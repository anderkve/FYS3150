...
plt.xlabel("h")
plt.savefig("abs_err_vs_h.png", dpi=300)
...
plt.ylabel("absolute error")
plt.xlabel("log10(h)")
plt.savefig("abs_err_vs_log10_h.png", dpi=300)
...
plt.xscale("log")
plt.yscale("log")
plt.savefig("abs_err_vs_h_loglog.png", dpi=300)
...
plt.xlabel("log10(h)")
plt.savefig("rel_err_vs_log10_h.png", dpi=300)
...
plt.xlabel("log10(h)")
plt.savefig("log10_rel_err_vs_log10_h.png", dpi=300)
...
plt.xscale("log")
plt.yscale("log")
plt.savefig("rel_err_vs_h_loglog.png", dpi=300)
